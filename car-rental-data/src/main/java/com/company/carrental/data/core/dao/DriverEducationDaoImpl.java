...
public class DriverEducationDaoImpl extends GenericDaoHibernate<DriverEducation, Integer> implements DriverEducationDao{

    public DriverEducationDaoImpl() {
        super(DriverEducation.class);
    }
    ...
    public List<DriverEducation> searchDriverEducation(Integer driverId){
        ...
        List<DriverEducation> driverEducations = super.findByRestrictions(operations);
